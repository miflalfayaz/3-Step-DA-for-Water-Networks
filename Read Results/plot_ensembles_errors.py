...
@author: ibrah
"""
def plot_ensembles_errors(y1,y2,y3,y4,ynames,yrange,yobs):
    import numpy as np
    ...
    f1 = figure(title= ynames[0], x_axis_label=' ', y_axis_label=ynames[0], height=300, width = 800)
    ...
    f1.circle(xx, np.mean(y1,1)- yobs, color='blue', size = 5)
    
    f2 = figure(title= ynames[1], x_axis_label=' ', y_axis_label=ynames[1], height=300, width = 800)
    ...
    f2.circle(xx, np.mean(y2,1)- yobs, color='blue', size = 5)
    
    f3 = figure(title= ynames[2], x_axis_label=' ', y_axis_label=ynames[2], height=300, width = 800)
    ...
    f3.circle(xx, np.mean(y3,1)- yobs, color='blue', size = 5)
    
    f4 = figure(title= ynames[3], x_axis_label='Node', y_axis_label=ynames[3], height=300, width = 800)
    ...
    f4.circle(xx, np.mean(y4,1)- yobs, color='blue', size = 5)
